<template>
    <div>
        ...
        <div class="max-w-5xl mx-auto mt-10 p-4">
            ...
            <div class="w-full bg-gray-300 h-2 rounded-full mb-8">
    ...
    export default {
        ...
        methods: {
            ...
            checkAnswer(answer) {
                ...
                this.score++;
                // Joue le son correct si l'élément audio est présent
                if (this.$refs.correctSound) {
                    this.$refs.correctSound.play().catch(error => console.error("Erreur lors de la lecture du son correct:", error));
                }
                } else {
                // Joue le son incorrect si l'élément audio est présent
                if (this.$refs.wrongSound) {
                    this.$refs.wrongSound.play().catch(error => console.error("Erreur lors de la lecture du son incorrect:", error));
                }
                }
                ...
                // Débloquer un badge à mi-chemin
            ...
            awardBadge(badgeName) {
                ...
                }, 3000); // Badge disparaît après 3 secondes
            },
        },
