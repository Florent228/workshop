<template>
    <!-- Start -->
    <section class="py-20 w-full table relative bg-[url('../../assets/images/gym/cta.jpg')] bg-center bg-no-repeat bg-fixed bg-cover">
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <a  @click="toggle" data-type="youtube" data-id="S_CGed6E610" class="lightbox size-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
                        <i class="mdi mdi-play inline-flex items-center justify-center text-2xl cursor-pointer"></i>
                    </a>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
