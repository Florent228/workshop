        ...
        <div class="container relative">
            ...
            <ul class="buy-button list-none mb-0">
                ...
                <li class="inline ps-1 mb-0">
                    <a href="https://1.envato.market/techwind-vue" target="_blank"
            ...
            <div id="navigation" :class="toggle === false ? 'none' : 'block'">
                ...
                <ul class="navigation-menu nav-light justify-end">
                    <li :class="activeMenu === '/index-photography' ? 'active' : ''"><router-link
                            to="/index-photography" class="sub-menu-item">Home</router-link></li>
                    <li :class="activeMenu === '/photography-about' ? 'active' : ''"><router-link to="/photography-about"
                            class="sub-menu-item">About Us</router-link></li>
                    <li :class="activeMenu === '/photography-portfolio' ? 'active' : ''"><router-link to="/photography-portfolio"
                            class="sub-menu-item">Portfolio</router-link></li>
                    <li :class="activeMenu === '/contact-two' ? 'active' : ''"><router-link to="/contact-two"
