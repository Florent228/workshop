<template>
    <div class="container relative md:mt-24 mt-16">
        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            <div class="relative">
                <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold"><span
                        class="text-indigo-600">Sign up now</span> and get the <br> best insurance on <br> the market
                </h3>
                ...
                <div class="flex items-center mt-6">
                    <img src="../../assets/images/client/01.jpg"
                        class="size-14 rounded-full shadow-md dark:shadow-gray-800 me-3" alt="">
                    <div class="flex-1">
            ...
            <div class="p-6 lg:ms-16 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center w-full mb-0">
                                ...
                                <label class="form-check-label text-slate-400" for="AcceptT&C">I Accept <a href=""
                                        class="text-indigo-600">Terms And Condition</a></label>
                            </div>
                        </div>

                        <router-link to="/auth-signup-success">
                            <div class="mb-4">
                                <input type="submit"
