<template>
  ...
  <div class="container relative">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div v-for="item in datas" :key="item" class="group relative rounded hover:-mt-1 shadow hover:shadow-md dark:shadow-gray-800 overflow-hidden duration-300">
                            ...
                            <div class="mt-3">
                                ...
                                <ul class="flex list-none justify-between mt-3 mb-2">
                                    <li class="font-semibold">
                                        <span class="text-indigo-600">{{item.raised}} </span>
            ...
            <!-- Start -->
        <section class="py-20 w-full table relative bg-[url('../../assets/images/charity/cta.jpg')] bg-top bg-no-repeat bg-cover md:mt-24 mt-16">
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <a @click="toggle" data-type="youtube" data-id="S_CGed6E610" class="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white cursor-pointer dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
...
export default {
    data() {
        return {
            ...
            datas: [
                {
                    image: require('../../assets/images/charity/cause01.jpg'),
                ...
                {
                    image: require('../../assets/images/charity/cause02.jpg'),
                ...
                {
                    image: require('../../assets/images/charity/cause03.jpg'),
                ...
                {
                    image: require('../../assets/images/charity/cause04.jpg'),
                ...
                {
                    image: require('../../assets/images/charity/cause05.jpg'),
                ...
                {
                    image: require('../../assets/images/charity/cause06.jpg'),
