<template>
    <div class="container relative md:mt-24 mt-16">
        <div class="grid lg:grid-cols-12 grid-cols-1 items-center gap-[30px] " :class="wowAnimate"
            data-wow-delay=".1s">
            ...
            <div class="lg:col-span-7 mt-8 lg:mt-0">
                <div class="lg:ms-8">
                    <div class="grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-[30px]">
                        <div class="group border-b-[3px] dark:border-gray-700 relative shadow dark:shadow-gray-800 rounded-md md:scale-110 z-3 bg-white dark:bg-slate-900 " :class="wowAnimate"
                            data-wow-delay=".3s">
                            <div class="p-6 py-8">
                                ...
                                <ul class="list-none text-slate-400">
                                    <li v-for="feature in features" :key="feature" class="mb-1 flex"><i
                                            class="uil uil-check-circle text-indigo-600 text-xl me-2"></i> {{feature}}
                                    </li>
                                </ul>
                                <a href=""
                        ...
                        <div class="group border-b-[3px] dark:border-gray-700 relative shadow dark:shadow-gray-800 rounded-md z-2 bg-gray-50 dark:bg-slate-800 " :class="wowAnimate"
                            data-wow-delay=".5s">
