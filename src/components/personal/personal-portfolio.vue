    ...
    <section class="relative md:mt-24 mt-16" id="portfolio">
        <div class="container relative">
            <div class="grid grid-cols-1 pb-8 text-center">
                ...
                <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Our Works &
                    Projects</h3>

                <p class="text-slate-400 max-w-xl mx-auto">Obviously I'm a Web Designer. Experienced with all stages of
                    the development cycle for dynamic web projects.</p>
            </div><!--end grid-->

            <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
                <div v-for="(item, index) in datas" :key="index.id" @click="viewBlogDetail.id"
                    class="group relative block overflow-hidden rounded-md duration-500">
                    <img :src="item.images"
                    ...
                    <div class="content">
                        ...
                        <div
                            ...
                            <router-link :to="{ name: 'portfolio-detail-one', params: { id: item.id } }"
