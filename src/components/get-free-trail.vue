<template>
    ...
    <section class="relative md:py-24 py-16 md:pt-0 pt-0">
            <div class="container relative z-1">
                <div class="grid grid-cols-1 justify-center " data-wow-delay=".1s" :class="wowAnimate">
                    <div class="relative ">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                    <a @click="toggle" data-type="youtube" data-id="S_CGed6E610"
                                        class="lightbox cursor-pointer size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white">
