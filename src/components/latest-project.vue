<template>
    <div class="container relative md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 items-end">
            <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Latest Projects & Works
            </h3>
            <p class="text-slate-400 max-w-xl">Explore and learn more about everything from machine learning and global
            ...
            <div class="tiny-six-item">
                <div v-for="(item, index) in datas" :key="index" class="tiny-slide">
                    <div class="group relative block overflow-hidden rounded-md duration-500 mx-2">
                        <a @click="showLightbox(index)" class="lightbox duration-500 group-hover:scale-105" title="">
                        ...
                        <div
                            ...
                            <router-link to="/portfolio-detail-two"
                                class="hover:text-indigo-600 text-lg duration-500 font-medium">{{ item.name }}</router-link>
