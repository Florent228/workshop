                ...
                <div class="grid lg:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    <div class="lg:col-span-3">
                        <div class="grid lg:grid-cols-1 grid-cols-2 sticky top-20">
                            <div class="counter-box relative md:text-start text-center">
                                <h1 class="font-bold text-3xl text-indigo-600 flex"><count-up class="counter-value"
                                       :end-val="11">3</count-up>+</h1>
                            ...
                            <div class="counter-box relative md:text-start text-center lg:mt-6">
                                <h1 class="font-bold text-3xl text-indigo-600"><count-up class="counter-value" :end-val="5">1</count-up>
                                </h1>
                    ...
                    <div class="lg:col-span-9">
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                            <div v-for="item in datas" :key="item" class="p-6 rounded-lg shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                                <div
                                    class="size-16 bg-indigo-600/5 border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800">
                                    <i :class="item.icon"></i>
                                </div>
