        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
            ...
            <div v-for="item in datas" :key="item"
                ...
                <div class="relative overflow-hidden">
                    ...
                    <div class="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                        <div class="pb-4 ps-4 flex items-center">
                            <img :src="item.image2" class="size-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto"
                                alt="">
                            <div class="ms-3">
                                <a href="" class="font-semibold text-white block">{{ item.name }}</a>
                                <span class="text-white/70 text-sm">{{ item.position }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content p-6 relative">
                    <router-link to="/course-detail"
                        class="font-medium block text-indigo-600">{{ item.course }}</router-link>
                    <router-link to="/course-detail"
                    ...
                    <div class="absolute -top-7 end-6 z-1 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                        <div
                            class="flex justify-center items-center size-14 bg-white dark:bg-slate-900 rounded-full shadow-lg dark:shadow-gray-800 text-indigo-600 dark:text-white">
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 mt-8">
            <div class="md:col-span-12 text-center">
                <router-link to="/course-listing"
                    ...
                    All Courses <i class="uil uil-arrow-right align-middle"></i></router-link>
            </div>
        </div><!--end grid-->
    </div><!--end container-->
    <!-- Start -->
    <section
        class="py-20 md:my-24 my-16 w-full table relative bg-[url('../../assets/images/coach/cta.jpg')] bg-top bg-no-repeat bg-cover">
        <div class="absolute inset-0 bg-slate-900/70"></div>
        <div class="container relative">
            <div class="grid grid-cols-1 text-center">
                <h3 class="mb-4 md:text-3xl text-2xl text-white font-medium">Self Development Course</h3>

                <p class="text-white/80 max-w-xl mx-auto">Start working with Techwind that can provide everything you
                    need to generate awareness, drive traffic, connect.</p>

                <div class="mt-8">
                    <a href=""
                        class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">JOIN
                        FOR FREE</a>
                </div>
            </div><!--end grid-->
        </div><!--end container-->
