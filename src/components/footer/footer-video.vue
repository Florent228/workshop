                ...
                <div class="container relative text-center">
                    <div class="grid md:grid-cols-3 grid-cols-1 items-center">
                        ...
                        <div class="text-center mt-6 md:mt-0">
                            <p class="mb-0">© {{date}} Techwind. Design with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                        </div>
