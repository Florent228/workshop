<template>
     <div class="container relative md:mt-24 mt-16">
                ...
                <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <ul v-for="item in datas" :key="item" class="space-y-8">
                        <li  class="shadow dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img :src="item.image" class="size-16 rounded-full shadow dark:shadow-gray-800" alt="">
                            ...
                            <div class="mt-6">
                                ...
                                <ul class="list-none mb-0 text-amber-400 mt-2 space-x-1">
                        ...
                        <li class="shadow dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img :src="item.image2" class="size-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                <div class="ps-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">{{item.name2}}</a>
                                    <p class="text-slate-400">{{item.position2}}</p>
                                </div>
                            </div>

                            <div class="mt-6">
                                <p class="text-slate-400">{{ item.desc2}}</p>
                                <ul class="list-none mb-0 text-amber-400 mt-2 space-x-1">
                                    <li class="inline"><i class="mdi mdi-star"></i></li>
                                    <li class="inline"><i class="mdi mdi-star"></i></li>
                                    <li class="inline"><i class="mdi mdi-star"></i></li>
