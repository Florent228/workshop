<template>
    <div class="container relative md:mt-24 mt-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
            <div v-for="blog in blogs" :key="blog.id" @click="viewBlogDetail(blog.id)"
                ...
                <div class="content p-6">
                    <router-link :to="{ name: 'blog-detail', params: { id: blog.id } }"
                        class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">{{ blog.title }}</router-link>
    ...
    data() {
        return {
            blogs: [
                {
                    id: 15,
                    image: require('../../assets/images/hotel/b1.jpg'),
                    title: 'Design your apps in your own way',
                    desc: 'The phrasal sequence of the is now so that many campaign and benefit'
                },
                {
                    id: 16,
                    image: require('../../assets/images/hotel/b2.jpg'),
                    title: 'How apps is changing the IT world',
                    desc: 'The phrasal sequence of the is now so that many campaign and benefit'
                },
                {
                    id: 17,
                    image: require('../../assets/images/hotel/b3.jpg'),
