                ...
                <div class="relative z-1">
                    <div class="grid lg:grid-cols-12 grid-cols-1 md:text-start text-center justify-center">
                        <div class="lg:col-start-2 lg:col-span-10">
                            <div class="relative">
                                <img src="../../assets/images/hospital/bg.jpg" class="rounded-md shadow-lg" alt="">
                            ...
                            <div class="lg:col-start-2 lg:col-span-10">
                                <div class="grid md:grid-cols-3 grid-cols-1 items-center">
                                    ...
                                    <div class="counter-box text-center">
                                        <h1 class="text-white text-4xl font-semibold mb-2 flex justify-center"><count-up class="counter-value"
                                                :start-val="10" :end-val="99">10</count-up>%</h1>
                                        <h5 class="counter-head text-white text-lg font-semibold mb-2">Positive feedback
                                        </h5>
                                    ...
                                    <div class="counter-box text-center">
                                        <h1 class="text-white text-4xl font-semibold mb-2 flex justify-center"><count-up class="counter-value"
                                                :start-val="2" :end-val="25">2</count-up>+</h1>
                                        <h5 class="counter-head text-white text-lg font-semibold mb-2">Experienced
                                            Clinics</h5>
                                    ...
                                    <div class="counter-box text-center">
                                        <h1 class="text-white text-4xl font-semibold mb-2 flex justify-center"><count-up class="counter-value"
                                                :start-val="95" :end-val="1251">95</count-up>+</h1>
                                        <h5 class="counter-head text-white text-lg font-semibold mb-2">Questions &
                                            Answers</h5>
