            ...
            <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 gap-[30px]">
                ...
                <div class="lg:col-span-3 md:col-span-5">
                    <div class="sticky top-20">
                        <ul class="flex-column p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md"
                            ...
                            <li v-for="item in datas" :key="item" role="presentation" class="mt-2 first:mt-0">
                                <button @click="toggle(item.id)" :class="item.id === activeId ? 'text-white bg-indigo-600 ' : 'dark:hover:bg-slate-800  hover:bg-gray-50'"
                                    class="px-4 py-2 text-start text-base font-semibold rounded-md w-full  duration-500"
                                    id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab"
                                    aria-controls="dashboard" aria-selected="true"><i :class="item.icon"></i>
                                    {{ item.name }}</button>
                            </li>
                            <li role="presentation" class="mt-2 first:mt-0">
                                    <router-link to="/auth-login" class="px-4 py-2 text-start text-base font-semibold rounded-md w-full mt-3 duration-500 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-white" type="button"><i class="uil uil-sign-out-alt text-[20px] me-2 align-middle"></i> Logout</router-link>
                                </li>
                ...
                <div class="lg:col-span-9 md:col-span-7">
                    <div id="myTabContent"
                        ...
                        <div :class="activeId === 1 ? '' : 'hidden'" id="dashboard" role="tabpanel" aria-labelledby="profile-tab">
                            <p class="text-slate-400 font-semibold">Hello <span
                                    class="text-slate-900 dark:text-white">cally_joseph</span> (not <span
                                    class="text-slate-900 dark:text-white">cally_joseph</span>? <a
                                    href="javascript:void(0)" class="text-red-600">Log out</a>)</p>

                            <p class="text-slate-400 font-semibold mt-4">From your account dashboard you can view your
                                <a href="javascript:void(0)" class="text-red-600">recent orders</a>, manage your <a
                                    href="javascript:void(0)" class="text-red-600">shipping and billing addresses</a>,
                                and <a href="javascript:void(0)" class="text-red-600">edit your password and account
                                    details</a>.</p>
                        </div>

                        <div :class="activeId === 2 ? '' : 'hidden'" id="order" role="tabpanel" aria-labelledby="order-tab">
                                ...
                                <table class="w-full text-start text-slate-500 dark:text-slate-400">
                                    ...
                                    <tbody>
                                        <tr class="bg-white dark:bg-slate-900 text-start">
                                            ...
                                            <td class="px-2 py-3 text-start">$ 320 <span class="text-slate-400">for
                                                    2items</span></td>
                                            <td class="px-2 py-3 text-start"><a href="javascript:void(0)"
                                                    class="text-indigo-600">View <i class="uil uil-arrow-right"></i></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-2 py-3 text-start">$ 800 <span class="text-slate-400">for
                                                    1item</span></td>
                                            <td class="px-2 py-3 text-start"><a href="javascript:void(0)"
                                                    class="text-indigo-600">View <i class="uil uil-arrow-right"></i></a>
                                            </td>
                        ...
                        <div :class="activeId === 3 ? '' : 'hidden'" id="download" role="tabpanel" aria-labelledby="download-tab">
                            <div class="relative overflow-x-auto shadow dark:shadow-gray-800 rounded-md">
                                <table class="w-full text-start text-slate-500 dark:text-slate-400">
                                    <thead class="text-sm uppercase bg-slate-50 dark:bg-slate-800">
                                        <tr class="text-start">
                                    ...
                                    <tbody>
                                        <tr class="bg-white dark:bg-slate-900 text-start">
                                            ...
                                            <td class="px-2 py-3 text-start">It is said that song composers of the past
                                                used dummy texts as lyrics when writing melodies in order to have a
                                                'ready-made' text to sing with the melody.</td>
                        ...
                        <div :class="activeId === 4 ? '' : 'hidden'" id="address" role="tabpanel" aria-labelledby="address-tab">
                                    ...
                                    <div class="pt-4 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <ul class="list-none">
                                            <li class="flex">
                                                ...
                                                <p class="text-slate-400">C/54 Northwest Freeway, Suite 558, <br>
                                                    Houston, USA 485</p>
                                            </li>
                        ...
                        <div :class="activeId === 5 ? '' : 'hidden'" id="accountdetail" role="tabpanel" aria-labelledby="accountdetail-tab">
                            ...
                            <div class="grid lg:grid-cols-2 grid-cols-1 gap-5 mt-6">
                                <div>
                                    ...
                                    <form>
                                        ...
                                        <button
                                            class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-5">Add</button>
                                    </form>
                                </div><!--end col-->
                                ...
                                <div>
                                    ...
                                    <form>
                                        ...
                                        <button
                                            class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-5">Save
                                            password</button>
                                    </form>
                                </div><!--end col-->
                            </div><!--end row-->
