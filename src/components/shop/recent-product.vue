...
export default {
    data() {
        return {
            datas: [
                {
                    image: require('../../assets/images/shop/items/s13.jpg'),
                    name: 'Wooden Chair',
                    price: '$16.00',
                    price2: '$21.00'
                },
                {
                    image: require('../../assets/images/shop/items/s14.jpg'),
                    name: 'Women Block Heels',
                    price: '$16.00',
                    price2: '$21.00'
                },
                {
                    image: require('../../assets/images/shop/items/s15.jpg'),
                    name: 'Shorts',
                    price: '$16.00',
                    price2: '$21.00'
                },
                {
                    image: require('../../assets/images/shop/items/s16.jpg'),
                    name: 'Masks',
                    price: '$16.00',
                    price2: '$21.00'
                },
