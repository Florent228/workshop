<template>
    ...
    <!-- Start -->
    <section
        class="py-28 w-full table relative bg-[url('../../assets/images/shop/cta.jpg')] bg-center bg-no-repeat bg-cover jarallax"
        data-jarallax data-speed="0.5">
        <div class="absolute inset-0 bg-slate-900/30"></div>
        <div class="container relative">
            <div class="grid grid-cols-1 text-center">
                <h3 class="mb-4 md:text-4xl text-3xl text-white font-bold">End of Season Clearance <br> Sale upto 30%
                </h3>
