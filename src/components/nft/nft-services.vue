      ...
      <!-- Start -->
            ...
            <div class="container relative">
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                    <!-- Content -->
                    <div v-for="service in services" :key="service" class="group relative px-6 py-10 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                        ...
                        <div class="mt-6">
                            <a href="" class="text-lg font-medium group-hover:text-white duration-500">{{ service.title }}</a>
                            <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">{{ service.desc }}</p>
                        </div>
                    </div>
                    <!-- Content -->
                </div><!--end grid-->
