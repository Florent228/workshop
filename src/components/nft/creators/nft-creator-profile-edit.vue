                    ...
                    <div class="group profile-pic w-[112px]">
                        ...
                        <div>
                            <div
                                ...
                                <img src="../../../assets/images/client/05.jpg" class="rounded-full" id="profile-image"
                                    alt="">
                ...
                <div class="lg:col-span-9 md:col-span-8">
                            ...
                            <div class="grid grid-cols-1">
                                <div class="mt-5">
                                    ...
                                    <textarea name="comments" id="comments"
                                        class="form-input w-full text-[15px] py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2"
                    ...
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                        ...
                        <div class="flex justify-between pb-4">
                            ...
                            <div class="">
                                <input
                                    class="form-checkbox rounded border-gray-200 dark:border-gray-800 text-indigo-600 focus:border-indigo-600/30 focus:ring focus:ring-offset-0 focus:ring-indigo-600/20 focus:ring-opacity-50"
                    ...
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                        ...
                        <router-link to="/explore-two"
                            class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Delete</router-link>
                    </div>
                </div>
            </div><!--end grid-->
        </div><!--end container-->
