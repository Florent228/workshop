<template>
    <div class="container relative md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Related Auction Items
            </h3>
            ...
            <div v-for="product in products" :key="product"
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <router-link to="/nft-detail"
                            class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Place
                            Bid</router-link>
                    </div>
                </div>
                ...
                <div class="p-6 relative">
                    <router-link to="/nft-detail"
                        class="text-lg font-semibold hover:text-indigo-600 duration-500 ease-in-out">{{ product.name }}</router-link>
