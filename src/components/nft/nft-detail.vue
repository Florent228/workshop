<template>
     <!-- Start Hero -->
            <div class="container relative">
                <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div class="lg:col-span-6 md:col-span-5">
                        <div class="sticky top-20">
                            <img :src="data?.image ? data.image : blogimage"  
                            class="rounded-md shadow-md dark:shadow-gray-800" alt="">
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="">
                            ...
                            <div class="grid md:grid-cols-2 grid-cols-1 mt-6">
                                ...
                                <div>
                                    ...
                                    <span id="auction-item-1" class="text-2xl font-semibold mt-2">   {{
                days + " : " + hours + " : " +
                minutes + " : " + seconds }}</span>
                            ...
                            <div class="grid grid-cols-1 mt-8">
                                <ul class="md:w-fit w-full flex-wrap justify-center text-center p-3 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md space-x-1" id="myTab" data-tabs-toggle="#StarterContent" role="tablist">
                                    ...
                                    <div :class="activeIndex === 1 ? '' : 'hidden'" class="" id="tuesday" role="tabpanel" aria-labelledby="tuesday-tab">
                                        <div class="grid grid-cols-1">
                                            ...
                                            <div class="flex items-center mt-3">
                                                <img src="../../assets/images/client/08.jpg" class="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="">
                                    ...
                                    <div :class="activeIndex === 2 ? '' : 'hidden'" id="wednesday" role="tabpanel" aria-labelledby="wednesday-tab">
                                        <div class="grid grid-cols-1">
                                            <div class="flex items-center">
                                                <div class="relative">
                                                    <img src="../../assets/images/client/01.jpg" class="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="">
                                                </div>
                                            ...
                                            <div class="flex items-center mt-4">
                                                <div class="relative">
                                                    <img src="../../assets/images/client/02.jpg" class="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="">
                                                </div>
                                            ...
                                            <div class="flex items-center mt-4">
                                                <div class="relative">
                                                    <img src="../../assets/images/client/03.jpg" class="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="">
                                                </div>
                                    ...
                                    <div :class="activeIndex === 3 ? '' : 'hidden'" id="thursday" role="tabpanel" aria-labelledby="thursday-tab">
                                        <div class="grid grid-cols-1">
                                            <div class="rounded-md shadow dark:shadow-gray-800 p-6">
                                                <div class="flex items-center">
                                                    <div class="relative">
                                                        <img src="../../assets/images/nft/items/1.jpg" class="size-20 rounded-md shadow-md dark:shadow-gray-800" alt="">
        ...
        <!-- Start Modal -->
        <dialog id="NftBid" class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
        ...
        <dialog id="NftBuynow" class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
            <div class="relative h-auto md:w-[480px] w-300px">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
    ...
    export default {
        data() {
            return {
                ...
                date: '',
            now: '',
            countDownToTime: new Date("Sep 26, 2025 00:00:00").getTime(),
        ...
        this.data = this.products.find((item) => item.id === parseInt(this.id))
